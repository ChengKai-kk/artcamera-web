...
.hero-overlay {
  ...
  gap: 10px;
  padding-bottom: clamp(20px, 6vh, 86px);
...
.hero-badge {
  ...
  color: #a5d8ff;
  font-weight: 700;
  font-size: clamp(60px, 7.3vh, 140px);
  letter-spacing: 4px;
  line-height: 1.1;
...
.hero-slogan {
  font-size: clamp(52px, 6.5vh, 106px);
  font-weight: 800;
}
...
.flow-banner {
  ...
  border-radius: 10px;
  padding: clamp(10px, 1.6vh, 18px) clamp(16px, 2.4vh, 28px);
...
.flow-title {
  font-weight: 700;
  font-size: clamp(30px, 3.6vh, 44px);
  color: #2f3134;
}
